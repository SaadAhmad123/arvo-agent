...
`,
      ...
      (t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
            ...
            for (var p = 0; p < d.length; p++) {
              ...
              for (var S = 0; S < L.length; S++)
                for (var w = L[S], k = this.invertedIndex[w], _ = k._index, f = 0; f < u.fields.length; f++) {
                  ...
                  if ((i[y].upsert(_, u.boost, (Ie, Ce) => Ie + Ce), !s[j])) {
          ...
          return v.sort((ke, Qe) => Qe.score - ke.score);
        }),
  ...
  async function ce(t, e) {
    ...
    const n = await fetch(window.searchData),
...
`),
  ...
  var Z = class extends I {
    constructor(e) {
      ...
      const r = this.summary.querySelector('a');
      r &&
  ...
  function Se(t, e, n) {
    ...
    if (t.children) {
      ...
      for (const u of t.children) Se(u, l, i);
    } else be(t, r, t.class);
  }
  function be(t, e, n) {
    if (t.path) {
